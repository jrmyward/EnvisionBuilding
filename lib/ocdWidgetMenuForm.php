...
class ocdWidgetMenuForm extends dmWidgetPluginForm
{
  ...
  public function configure()
  {
    ...
    parent::configure();
    $this->widgetSchema['ulId']      = new sfWidgetFormInputText(array(
      'label' => 'UL CSS Id'
    ));
    $this->validatorSchema['ulId']   = new dmValidatorCssClasses(array('required' => false));
