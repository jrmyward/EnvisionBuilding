...
class ocdMenu extends dmMenu
{
  ...
  public function ulId($class)
  {
    return $this->setOption('ul_id', $class);
  }
  ...
  public function renderLink()
  {
    if ($this->hasChildren() && $this->getOption('show_children'))
    {
      return $this->getLink()->set('.sf-with-ul')->text('<span>'.$this->__($this->getLabel()).'</span><span class="sf-sub-indicator">&raquo;</span>')->render();
    }
    else
    {
      return $this->getLink()->text('<span>'.$this->__($this->getLabel()).'</span>')->render();
    }
  }
